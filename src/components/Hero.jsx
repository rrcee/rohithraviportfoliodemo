  ...
  return (
    <section className="relative w-full h-[100svh] flex items-center justify-center overflow-hidden bg-inverse">
      ...
      >
        {hasEntered && (
          <iframe
            src={`https://www.youtube.com/embed/2BlPuiV8pLY?autoplay=1&mute=0&controls=0&showinfo=0&rel=0&loop=1&playlist=2BlPuiV8pLY&modestbranding=1&playsinline=1`}
            title="Rohith Ravi Reel"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
            className="w-[300vw] h-[300vh] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 sm:w-[150vw] sm:h-[150vh] object-cover pointer-events-none grayscale-[20%]"
          />
        )}
      </motion.div>
      ...
      <div className="relative z-10 px-6 w-full max-w-7xl mx-auto flex flex-col justify-end h-full pb-16 sm:pb-24">
        ...
        <div className="flex flex-col w-full max-w-2xl gap-10">
          <div>
            ...
            >
              <div className="h-[1px] w-8 bg-inverse-text"></div>
              <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.4em] font-mono text-inverse-text block">
                Kerala & Worldwide
              </span>
            </motion.div>

            <h1 className="font-sans text-[11vw] sm:text-[9vw] font-bold tracking-tighter text-inverse-text leading-[0.85] uppercase flex flex-col">
              <motion.span 
              ...
              <motion.span 
                ...
                className="block text-inverse-text/80"
              >
                Documentation
              </motion.span>
            </h1>
